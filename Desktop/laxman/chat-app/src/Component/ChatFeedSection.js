...
const ChatFeedSection = () => {
  ...
  "
    >
      ...
      <div className="chat-bot-section px-5 pt-3" style={{ width: "100%", height: "81vh", overflow: "auto" }}>

        {/* today label */}
        <div className="day-label d-flex align-items-center">
          <span className="hr-line"></span>
          <div className="day  ">
            <p className="subheafdding d-flex align-items-center pt-2 px-2">yesterday</p>
          </div>
          <span className="hr-line"></span>
        </div>
        ...
        <div className="day-label d-flex align-items-center">
          <span className="hr-line"></span>
          <div className="day  ">
            <p className="subheafdding d-flex align-items-center pt-2 px-2">Today</p>
          </div>
          <span className="hr-line"></span>
        </div>
      ...
      <div className="message-type-section d-flex py-3 justify-content-evenly align-items-center" style={{ background: "white" }}>
        <ul className="list-unstyled d-flex">
        ...
        <div className="input-section " style={{ width: "88%" }} >
          <input type="text" placeholder="write message here" style={{
            width
              : "100%", padding: "0.8rem 0.4rem"
          }} />
        </div>
        <div className="send-button">
          <button className="btn border"><i class="fa-solid fa-paper-plane" style={{ padding: "0.8rem 0.4rem" }}></i></button>
        </div>
      </div>
