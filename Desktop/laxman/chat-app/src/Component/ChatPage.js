  ...
  return (
    <div className="chat-section">
      ...
      <div className="serch-section position-relative px-4 pb-4">
        <p className="serch-icon position-absolute ">
          <i class="fa-solid fa-magnifying-glass"></i>
        </p>
        <input
          type="text"
          className="w-100 serch-bar"
      ...
      <div className="conversation-chat-recent px-4 ">
        ...
        <div className="recent-user">
          <ul
            className="list-unstyled recent-user"
            id="myScrollbar"
            style={{ width: "100%", maxHeight: "73vh", overflow: "auto" }}
          >
